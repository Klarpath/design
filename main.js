document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- 1. Define the content for each policy ---
        ...
        <p class="mb-4"><strong>Code Ownership & Monthly Fees:</strong> For our Launchpad and Growth Starter plans, the monthly fee is part of a 24-month agreement which culminates in you owning the website code. This fee covers the development cost, premium hosting, security, and maintenance. After 24 months, you own the code and can choose to move to a maintenance-only plan or manage the site yourself. Alternatively, you can purchase the website outright with a one-time fee for immediate ownership.</p>
